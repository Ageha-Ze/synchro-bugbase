...
const { theme, setTheme } = useTheme();
  ...
  return (
   <aside className="h-screen w-64 flex flex-col bg-white dark:bg-gray-900 border-r border-indigo-100 dark:border-gray-800 shadow-sm overflow-hidden md:static md:w-64 transition-colors duration-300">
  {/* Header */}
