      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-indigo-200 rounded-lg bg-indigo-50/50 text-slate-700 focus:bg-white focus:ring-2 focus:ring-indigo-500 transition-all"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white rounded-2xl shadow border border-indigo-100 p-6">
            ...
            <div className="bg-white rounded-2xl shadow border border-red-100 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 font-medium">Open Bugs</p>
